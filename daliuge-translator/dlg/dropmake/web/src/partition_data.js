...
<body>
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark" style="background-color: #004085;">
        ...
        <span class="navbar-text text-muted">{{version}}</span>
            ...
            <ul class="nav navbar-nav navbar-center">
                ...
                <!-- <li class="nav-item dropdown">
                    ...
                    <div id="oriantationDropdown" class="dropdown-menu dropdown-menu-right" aria-labelledby="GraphOrientationDropdown">
                        <div class="orientationOptionContainer"><input type="radio" name="direction" onclick="layout()" value="0" checked="checked" /><a href="javascript:void(0)" class="inactiveLink nav-link">Down</a></div>
                        <div class="orientationOptionContainer"><input type="radio" name="direction" onclick="layout()" value="90" /><a href="javascript:void(0)" class="inactiveLink nav-link">Left</a></div>
                        <div class="orientationOptionContainer"><input type="radio" name="direction" onclick="layout()" value="180" /><a href="javascript:void(0)" class="inactiveLink nav-link">Up</a></div>
                        <div class="orientationOptionContainer"><input type="radio" name="direction" onclick="layout()" value="270" /><a href="javascript:void(0)" class="inactiveLink nav-link">Right</a></div>
                    </div>
                </li> -->
                <div class="btn-group" role="group" id="view-mode-buttons">
                    ...
                    <button type="button" id="partitionButton" onclick="graphInit('partition')" class="btn btn-secondary tooltip tooltipBottom graphChanger" data-text="View Partition Graph" >Partition</button>
                </div>
            </ul>
                ...
                <div class="modal-body">
                    <form action="/gen_pg" method="get" target="deploy_target" name="deploy_target" id="pg_form" >
                        <div id="neccessaryHiddenItems">
                            <input id="managerUrlInput" type="text" name="dlg_mgr_url" value="http://dlg-dim.localhost" size="40" style="font-size:16px;">
    ...
    <script src="/static/src/partition_data.js"></script>
    <script src="/static/src/partition_graph.js"></script>
